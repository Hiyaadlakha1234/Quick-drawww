...
sketch_to_be_drawn = quick_draw_data_set[randomNumber];
document.getElementById("sketchtobedrawn").innerHTML = sketch_to_be_drawn;
timer_counter = 0;
timer_check = "";
drawn_sketch = "";
answer_holder = "";
...
function getResults(error, results) {
    if (error) {
        ...
        doodle_confidence = Math.round(results[0].confidence * 100);
